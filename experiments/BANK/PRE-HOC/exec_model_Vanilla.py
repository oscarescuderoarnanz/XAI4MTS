...
if __name__ == "__main__":
    ...
    layer_list = [
        [input_shape, 3, 1], [input_shape, 4, 1], [input_shape, 6, 1],
        [input_shape, 8, 1], [input_shape, 10, 1], [input_shape, 12, 1],
        [input_shape, 14, 1], [input_shape, 16, 1]
    ]
    ...
    for i in [1, 2, 3]:
        ...
        split_directory = './Results_Vanilla_CMI/split_' + str(i)
...
cd ../.."patience": hyperparameters["patience"],
