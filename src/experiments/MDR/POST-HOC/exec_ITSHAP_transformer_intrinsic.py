...
from non_rnn_architectures.transformer_poshoc import *
from utils import *

sys.path.append("../../../code/explainability_methods/ITSHAP")
import TFWrapper, XAI_utils, utils_visualizations_IT_SHAP
...
if __name__ == "__main__":
    ...
    model = load_model('../INTRINSIC/Results_transformer_Had/split_1/model_split_1.h5', custom_objects={'PositionalEncoding': PositionalEncoding})
    ...
    # Step 2. Create data frame of train data
    data = X_train
    ...
    save_to_pickle(results_shap, os.path.join(directory, f"results_shap_intrinsic_{split}.pkl"))