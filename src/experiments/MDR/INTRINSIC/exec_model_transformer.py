...
from non_rnn_architectures.transformer_intrinsec import *
from utils import *
...
if __name__ == "__main__":
    ...
    hyperparameters = {
        ...
        "verbose": 0,
        'dataset': dataset,
        # Inner dimension of the feed-forward sublayer in each Transformer block
        "ff_dim": 128,
        "num_heads": 4,
    ...
    if run_model:
        ...
        for i in range(1,4):
            ...
            split_directory = './Results_transformer_Had/split_' + str(i)
