...
if __name__ == "__main__":
    ...
    hyperparameters = {
        ...
        "verbose": 0,
        'dataset': dataset,
        "num_heads": 4,           # number of MultiHeadAttention heads
        "ff_dim": 128,            # feed-forward inner dimension
        "num_transformer_blocks": 2  # how many Transformer blocks to stack
    }
    ...
    for i in range(1,4):
        ...
        bestHyperparameters = myCVGridParallel(hyperparameters,
                                               ...
                                               n_time_steps)
        fin = time.time()
        print("TIEMPO TOTAL POR SPLIT (CV): ", fin - init)
        ...
        split_directory = './Results_transformer_CCMI/split_' + str(i)
